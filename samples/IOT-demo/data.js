...
const ControlList = [
  {
    ...
    noCircle: false,
    panelElements: ['p1wOq31j+0/100227'],
    panelData: [
      {
        lineDirection: 'top',
        panelContent: {
    ...
    },
    {
      ...
      noCircle: false,
      panelElements: ['p1wOq31j+0/101575'],
      panelData: [
        {
          lineDirection: 'left',
          panelContent: {
    ...
    },
    {
      ...
      panelElements: ['p1wOq31j+0/101676'],
      noCircle: false,
      panelData: [
        {
          lineDirection: 'left',
    ...
    },
    {
      ...
      noCircle: false,
      panelElements: ['p1wOq31j+0/101496', 'p1wOq31j+0/101506'],
      panelData: [
        {
          lineDirection: 'left',
          panelContent: {
...
const WaterFlowMaxMin = {
  "path0": [[-29951.800,-5068.000,-4168.320],[-29151.800,-4268.000,-3482.895]],
  "path1": [[-29996.800,-6173.000,-4056.304],[-29106.800,-5283.000,-3010.154]],
  "path2": [[-29996.800,-7373.000,-4056.304],[-29106.800,-6483.000,-3010.154]],
  "path3": [[-29951.800,-8388.000,-4168.320],[-29151.800,-7588.000,-3482.895]]
}
