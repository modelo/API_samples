                ...
                Modelo.Model.getComments(
                    ...
                    function onSuccess(comments) {
                        for (let i = 0; i < comments.length; i++) {
                            ...
                            var itemCamera = document.createElement("div");
                            itemCamera.className = "item";
                            itemCamera.innerHTML = "Camera: " + comments[i].renderData.camera;
                            var itemCreateBy = document.createElement("div");
                            itemCreateBy.className = "item";
                            itemCreateBy.innerHTML = "CreatedBy:" + comments[i].userData;
                            ...
                            divUiList.appendChild(itemCamera);
                            divUiList.appendChild(itemCreateBy);
